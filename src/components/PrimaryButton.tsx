  ...
  return (
    <button
      className={[
        ...
        'interactive-press active:bg-[#3A352F] disabled:cursor-not-allowed disabled:border-[#DED8CF] disabled:bg-[#EFE8DD] disabled:text-[#6F6A63] disabled:active:scale-100',
